<!-- VISA Modal -->
<div id="visaModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50" role="dialog" aria-labelledby="visaModalTitle" aria-hidden="true">
